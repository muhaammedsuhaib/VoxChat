...
const Sidebar = () => {
  ...
  return (
    <div className="grid grid-cols-12">
      <div className="fixed left-0 top-0 h-full w-16 p-4 mt-14 flex-col gap-8 items-center bg-[#FFFFFF] hidden md:flex">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0ZM3 19.235v-.11a6.375 6.375 0 0 1 12.75 0v.109A12.318 12.318 0 0 1 9.374 21c-2.331 0-4.512-.645-6.374-1.766Z" />
      ...
      <div className="col-span-11 ml-16">
        ...
        <div className={`fixed bottom-0 w-full md:hidden text-start p-2 flex justify-around`}>
        {/* <div 
          className={`w-auto h-auto group mt-10 ${activeButton === 1 ? 'scale-110 text-black' : 'hover:scale-110 text-gray-500'}`}
          onClick={() => handleButtonClick(1)}
        >
