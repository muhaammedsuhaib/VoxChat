      ...
      <div className="grid grid-cols-12">
        <div className="fixed left-0 top-0 h-full w-16 p-4 mt-14 flex flex-col gap-8 items-center bg-[#FFFFFF]">
          ...
          <div className="w-auto h-auto group">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-7 transition duration-300 ease-in-out transform hover:scale-110">
