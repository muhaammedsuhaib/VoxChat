...
const Sidebar = () => {
  ...
  return (<>
    <div className="grid grid-cols-12 hidden md:block">
      <div className="fixed left-0 top-0 h-full w-16 p-4 mt-14 flex flex-col gap-8 items-center bg-[#FFFFFF]">
        ...
        <div 
          ...
          onClick={() =>{  handleButtonClick(1) ,nav('/')}}
        >
        ...
        <div 
          ...
          onClick={() =>{  handleButtonClick(2),nav('/calls') }}
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-7 transition duration-300 ease-in-out">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0ZM3 19.235v-.11a6.375 6.375 0 0 1 12.75 0v.109A12.318 12.318 0 0 1 9.374 21c-2.331 0-4.512-.645-6.374-1.766Z" />
    ...
    <div className={`fixed bottom-0 w-full md:hidden text-start p-1 flex justify-around`}>
        {/* message icon */}
        <div 
          className={`w-auto h-auto group  ${activeButton === 1 ? 'scale-110 text-black' : 'hover:scale-110 text-gray-500'}`}
          onClick={() =>{  handleButtonClick(1) ,nav('/')}}
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-7 transition duration-300 ease-in-out">
            <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 0 1-2.555-.337A5.972 5.972 0 0 1 5.41 20.97a5.969 5.969 0 0 1-.474-.065 4.48 4.48 0 0 0 .978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25Z" />
